...
public class OrderUtil {
  ...
  public static List<Product> getProducts() {
    ...
    products.add(initProduct(Ivy.cms().co("/Project/Products/Table"),
      Double.parseDouble(Ivy.var().get("table")), ClearanceLevel.HEAD));
    products.add(initProduct(Ivy.cms().co("/Project/Products/Chair"),
      Double.parseDouble(Ivy.var().get("chair")), ClearanceLevel.AGENT));
    return products;
  }
