...
Os0 f0 inParameterMapAction 'out.availableProducts=order.OrderUtil.getProducts();
' #txt
Os0 f0 inActionCode 'import ch.ivyteam.ivy.project.demo.ci.order.Product;
...
Os0 f0 outParameterDecl '<java.util.List<ch.ivyteam.ivy.project.demo.ci.order.Product> order> result;' #txt
...
>Proto Os0 .type ch.ivyteam.ivy.project.demo.ci.order.OrderForm.OrderFormData #txt
