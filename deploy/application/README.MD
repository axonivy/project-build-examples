...
`requires project-build-plugin 7.1.0-SNAPSHOT and Axon.ivy Engine 7.1.0 RC or newer` 
  ...
  <executions>
    <execution>
      ...
      <configuration>
        ...
        <deployEngineDirectory>\\myStagingSrv\ivyEngine71\deploy</deployEngineDirectory>
      </configuration>
    </execution>
  </executions>
</plugin>
