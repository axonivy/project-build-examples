...
Me0 f0 type ci.deploy.customer.Data #txt
Me0 f0 inParamDecl '<> param;' #txt
Me0 f0 actionDecl 'ci.deploy.customer.Data out;
' #txt
Me0 f0 guid 15F259DEAE0A69BB #txt
...
Me0 f1 type ci.deploy.customer.Data #txt
Me0 f1 497 49 30 30 0 15 #rect
Me0 f1 @|EndIcon #fIcon
Me0 f3 targetWindow NEW #txt
Me0 f3 targetDisplay TOP #txt
Me0 f3 richDialogId ci.deploy.solution.UserManager #txt
Me0 f3 startMethod start() #txt
Me0 f3 type ci.deploy.customer.Data #txt
...
' #txt
Me0 f3 isAsynch false #txt
Me0 f3 isInnerRd false #txt
Me0 f3 userContext '* ' #txt
Me0 f3 168 42 112 44 0 -7 #rect
Me0 f3 @|RichDialogIcon #fIcon
Me0 f4 expr out #txt
Me0 f4 111 64 168 64 #arcP
Me0 f5 actionDecl 'ci.deploy.customer.Data out;
' #txt
...
Me0 f5 type ci.deploy.customer.Data #txt
Me0 f5 328 42 112 44 0 -7 #rect
Me0 f5 @|StepIcon #fIcon
Me0 f6 expr out #txt
